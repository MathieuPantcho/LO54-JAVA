...
@WebServlet(name = "AddCourseSessionKOServlet", urlPatterns = {"/AddCourseSessionKOServlet"})
public class AddCourseSessionKOServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
                ...
                out.println("</head>");
                out.println("<body>");
                out.println("<h1>Erreur lors de l'ajout d'une course session</h1>");
                out.println("<a href=/backoffice/ class=\"btn btn-primary\"  role=\"button\" style=\"margin-bottom: 5px;\">Revenir à l'acceuil</a><br>");
                out.println("<a href=/backoffice/addCourseSessionForm.jsp class=\"btn btn-primary\"  role=\"button\" style=\"margin-bottom: 5px;\">Réessayer l'ajout</a><br>");
                out.println("</body>");
                out.println("</html>");
        }
    }
