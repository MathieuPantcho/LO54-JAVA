...
@WebServlet(name = "AddCourseOkServlet", urlPatterns = {"/addCourseOk"})
public class AddCourseOkServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<!DOCTYPE html>");
                ...
                out.println("<a href=/backoffice/addCourseForm.jsp class=\"btn btn-primary\"  role=\"button\" style=\"margin-bottom: 5px;\">Revenir à manager course</a><br>");
                out.println("</body>");
                out.println("</html>");
        }
    }
