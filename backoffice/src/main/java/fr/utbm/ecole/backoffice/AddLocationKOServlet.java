...
@WebServlet(name = "AddLocationKOServlet", urlPatterns = {"/addLocationKO"})
public class AddLocationKOServlet extends HttpServlet {
        ...
        try ( PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
             out.println("<!DOCTYPE html>");
                ...
                out.println("<a href=/backoffice/addLocationForm.jsp class=\"btn btn-primary\"  role=\"button\" style=\"margin-bottom: 5px;\">Réessayer l'ajout</a><br>");
                out.println("</body>");
                out.println("</html>");
        }
    }
